...
git clone https://github.com/crdroidandroid/android_device_samsung_a10 -b 14.0-test device/samsung/a10
git clone https://github.com/Masood-J/android_device_samsung_exynos7885 -b A14-T device/samsung/universal7885-common
